...
@SuperBuilder
@NoArgsConstructor
public class DivideBlock extends ArithmeticBlock {
    ...
    public ExecutionResult execute(ExecutionContext context) {
        ...
        if (getResultVariableId() == null) {
            throw new IllegalStateException("resultVariableId is required for DIVIDE block");
        }
        ...
        context.sendDebug("DIVIDE", getResultVariable() + " = " + num1 + " / " + num2 + " = " + result);
