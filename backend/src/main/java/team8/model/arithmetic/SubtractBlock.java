...
@Entity
@Table(name = "subtract_blocks")
@DiscriminatorValue("SUBTRACT")
@Data
...
public class SubtractBlock extends ArithmeticBlock {
    ...
    public ExecutionResult execute(ExecutionContext context) {
        ...
        if (getResultVariableId() == null) {
            throw new IllegalStateException("resultVariableId is required for SUBTRACT block");
        }
        ...
        context.sendDebug("SUBTRACT", getResultVariable() + " = " + num1 + " - " + num2 + " = " + result);
